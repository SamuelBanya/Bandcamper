...
def writeTags(genre_tag_list, location_tag_list):
    ...
    with open('/var/www/musimatic/pythonprojectwebsites/Bandcamper/tags.html', 'w') as f:
        ...
        f.write('<a class="navbar-brand" href="#">Container XL</a>')
        ...
        f.write('<a class="nav-link active" aria-current="page" href="#">Home</a>')
        f.write('</li>')
        f.write('<li class="nav-item">')
        f.write('<a class="nav-link" href="#">Link</a>')
        f.write('</li>')
        f.write('<li class="nav-item">')
        f.write('<a class="nav-link disabled">Disabled</a>')
        f.write('</li>')
        f.write('<li class="nav-item dropdown">')
        f.write('<a class="nav-link dropdown-toggle" href="#" id="dropdown07XL" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</a>')
        f.write('<ul class="dropdown-menu" aria-labelledby="dropdown07XL">')
        f.write('<li><a class="dropdown-item" href="#">Action</a></li>')
        f.write('<li><a class="dropdown-item" href="#">Another action</a></li>')
        f.write('<li><a class="dropdown-item" href="#">Something else here</a></li>')
        f.write('</ul>')
        f.write('</li>')
        f.write('</ul>')
        f.write('<form>')
        f.write('<input class="form-control" type="text" placeholder="Search" aria-label="Search">')
        f.write('</form>')
        f.write('</div>')
        f.write('</div>')
        f.write('</nav>')
